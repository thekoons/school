...
int main()
{
    ...
    salaried_employee manager_training;

    cout<<"\nName of person applying: ";
    manager_training.read();
    cout<<"\nSalary rate?: ";
    cin>>rate; cin.ignore(100,'\n');
    manager_training.set_pay(rate);
    
    manager my_manager(manager_training);
    employee * ptr = &my_manager;
    ptr->display();
    ...
    manager man;
    man.create_a_group(all_employees);
